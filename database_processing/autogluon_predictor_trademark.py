...
predictor = TabularPredictor.load("/home/likas/workspace/github.com/Likas07/data_analysis/database_processing/AutogluonModels/Trademark_model", verbosity = 4)
# Time the prediction
...
results_df['Predicted_Trademark'] = y_pred
...
high_confidence.to_excel('predictions_high_confidence_trademark.xlsx', index=False)
low_confidence.to_excel('predictions_for_review_trademark.xlsx', index=False)
...
confidence_summary.to_excel('confidence_distribution_summary_trademark.xlsx', index=False)
